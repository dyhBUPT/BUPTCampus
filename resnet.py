"""Copied from https://github.com/mangye16/DDAG/blob/master/resnet.py"""
import torch.nn as nn
import math
import torch.utils.model_zoo as model_zoo

__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152', 'remove_fc', 'model_urls']
...
class ResNet(nn.Module):
  ...
  def __init__(self, block, layers, last_conv_stride=2, last_conv_dilation=1, input_channel=3):
